...
from rewave.environment.discrete_portfolio import DiscretePortfolioEnv
...
def main():
    ...
    while True:
        ...
        cur_state = cur_state['history']
        print("cur_state shape:", cur_state.shape)
        cur_state = cur_state.reshape((1, env.observation_space.spaces['history'].shape[0],
                                       env.observation_space.spaces['history'].shape[1],
                                       env.observation_space.spaces['history'].shape[2]))
        ...
        print("new_history shape:", new_history.shape)
        new_history = new_history.reshape((1, env.observation_space.spaces['history'].shape[0],
                                           env.observation_space.spaces['history'].shape[1],
                                           env.observation_space.spaces['history'].shape[2]))
