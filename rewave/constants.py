...
DATABASE_DIR = path.realpath(__file__).\
    replace('rewave/constants.pyc','/marketdata/Data.db').\
    replace("rewave\\constants.pyc","marketdata\\Data.db").\
    replace('rewave/constants.py','/marketdata/Data.db').\
    replace("rewave\\constants.py","marketdata\\Data.db")
...
# nomalize the names for the features
FEATURES = ["open", "high", "low", "close", "volume", "ex_dividend", "split", "adj_open", "adj_high", "adj_low", "adj_close", "adj_volume"]

# dictionnary for Quandle
QUANDL_TRANSLATE = {"open":"open", "high":"high", "low":"low", "close":"close", "volume":"volume",
                    "ex_dividend":"ex_dividend", "split":"split",
                    "adj_open":"adj_open", "adj_high":"adj_high", "adj_low":"adj_low", "adj_close":"adj_close", "adj_volume":"adj_volume"}
