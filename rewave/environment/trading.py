##########
# source https://github.com/Prediction-Machines/Trading-Gym/blob/master/tgym/envs/trading.py
##########
...
class SpreadTrading(Env):
    ...
    def __init__(self, data_generator, spread_coefficients, episode_length=1000, trading_fee=0, time_fee=0,
                 history_length=2):
