...
class OpenAIGymCustom(Environment):
    ...
    @property
    def states(self):
        return OpenAIGymCustom.state_from_space(space=self.gym.observation_space)
    ...
    def state_from_space(space):
        if isinstance(space, gym.spaces.Discrete):
            ...
            for subspace in space.spaces:
                state = OpenAIGymCustom.state_from_space(space=space.spaces[subspace] )
                states[subspace] = state
            return states
    ...
    @property
    def actions(self):
        return OpenAIGymCustom.action_from_space(space=self.gym.action_space)
